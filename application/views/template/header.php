     ...
     <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Web Reviews Restaurants</a>
            </div>
            <!-- /.navbar-header -->
            <div>
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href='<?php echo base_url();?>index.php/welcome/Diseplay'><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href='<?php echo base_url();?>index.php/usersingin/logout'><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i> Reviews</a>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href='<?php echo base_url();?>index.php/formres_controller/showAllres'> Restaurants</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa fa-photo fa-fw"></i> Photos</a>
                        </li>
                        <li>
